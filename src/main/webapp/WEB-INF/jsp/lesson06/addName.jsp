	...
	<div class="container">
		<h1>회원 정보 추가</h1>
			...
			<div class="form-group">
				...
				<small id="nameStatusArea"><span></span></small>
			</div>
...
$(document).ready(function(){
	...
	$("#nameCheckBtn").on("click", function(){
		...
		// validation
		if(name == ""){
			$("#nameStatusArea").append('<span class="text-danger">이름이 비어있습니다.</span>'); // 태그 추가할땐 append();
			return;
		}
			...
			, success:function(data){
				// {"isDuplication":true}
					if(data.isDuplication == true){
							$("#nameStatusArea").append('<span class="text-danger">이름이 중복되었습니다.</span>'); // 태그 추가할땐 append();
					}
			}
	...
	$("#joinBtn").on("click", function(){
		// nameStatusArea 상자 하위 노드(객체, 태그)들이 있는지 확인
